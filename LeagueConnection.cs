...
namespace ChallengesAreEvil
{
    ...
    public class LeagueConnection
    {
        ...
        private void HandleMessage(object sender, MessageEventArgs args)
        {
            ...
            var payload = JsonConvert.DeserializeObject<List<object>>(args.Data);
        ...
        public async Task<HttpResponseMessage> Patch(string url, string body)
        {
            ...
            return await HTTP_CLIENT.PatchAsync("https://127.0.0.1:" + processInfo.Item3 + url, new StringContent(body, Encoding.UTF8, "application/json"));
        }
